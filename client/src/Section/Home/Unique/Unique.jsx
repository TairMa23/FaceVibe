                ...
                <div className='flex items-start flex-col md:flex-row'>
                    <div className="text-left w-full">  
                        <div className="text-center">  
                            <h2 className='text-sectionTitle text-6xl text-textBlue fnt font-bold'>About Us</h2>
                        </div>
                        <h5 className='text-[#ACABC3] text-2xl font-medium flex items-center gap-2 pt-10'>
                            <span className="bg-my-pink rounded-full min-h-3 min-w-3"></span>
                            Who we are?
                        </h5>
                        <h5 className='text-[#ACABC3] text-xl font-medium pt-1'>
                        ...
                        <h5 className='text-[#ACABC3] text-2xl font-medium flex items-center gap-2 py-2 pt-8'>
                        ...
                        <h5 className='text-[#ACABC3] text-2xl font-medium flex items-center gap-2 py-1 pt-8'>
                            <span className="bg-[#2BF5CC] rounded-full min-h-3 min-w-3"></span>
                            The technologies we use
                        </h5>
                        <h5 className='text-[#ACABC3] text-xl font-medium pt-2'>
                        ...
                        <h5 className='text-[#ACABC3] text-2xl font-medium flex items-center gap-2 py-1 pt-8'>
                            <span className="bg-[#FFB265] rounded-full min-h-3 min-w-3"></span>
                            Why choose us?
                        </h5>
                        <h5 className='text-[#ACABC3] text-xl font-medium pt-2'>
