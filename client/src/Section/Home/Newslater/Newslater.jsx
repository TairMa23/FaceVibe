        ...
        <div id="NewslaterSection" className="relative" style={divStyle}>
            ...
            <div className="textDiv relative z-10 flex flex-col justify-center items-center container mx-auto">
                <div className='flex flex-col justify-start justify-center items-center container mx-auto'>
                    <h2 className='text-4xl text-sectionTitle font-bold fnt text-center mb-12'>Contact Way</h2>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        <div className='flex items-center gap-2'>
                            <span className="bg-[#afc3f2] rounded-full min-h-10 min-w-10"></span>
                        ...
                        <div className='flex items-center gap-2'>
                            <span className="bg-[#d596b5] rounded-full min-h-10 min-w-10"></span>
                            <div className='flex flex-col text-textBlue text-lg font-semibold'>
                        ...
                        <div className='flex items-center gap-2'>
                            <span className="bg-[#f0b8ac] rounded-full min-h-10 min-w-10"></span>
                            <div className='flex flex-col text-textBlue text-lg font-semibold'>
